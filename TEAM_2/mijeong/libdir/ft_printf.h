...
/*   Updated: 2020/11/08 23:55:17 by mijeong          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int						bankround(int count, union u_f *result, long long int *front, t_key *key);
int						bitcheck(union u_f result, t_key *key);
/*
**util.c
*/
int						d_util(t_key *key, long long int result);
int						x_util(t_key *key, int ul_switch, unsigned long long int result);
...
**bankround2.c
*/
int						bankround_div(union u_f *result, long long int *front, t_key *key, int count);
#endif